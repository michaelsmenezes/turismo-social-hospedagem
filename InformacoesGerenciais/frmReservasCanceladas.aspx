<%@ Page Title="Relação de Reservas Canceladas" Language="VB" MasterPageFile="~/TurismoSocial.master" AutoEventWireup="false" CodeFile="frmReservasCanceladas.aspx.vb" Inherits="InformacoesGerenciais_frmReservasCanceladas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="conPlaHolTurismoSocial" Runat="Server">
    ...
    <asp:Panel ID="pnlConsulta" runat="server">
        <div class="formRuler" style="font-size: large; font-weight: bold">
            &nbsp;&nbsp;Relação de Reservas Canceladas</div>
        <br />
    ...
    <br />
&nbsp;&nbsp;&nbsp;
    <rsweb:ReportViewer ID="rptReservasCanceladas" runat="server" Height="" SizeToReportContent="True" Visible="False" Width="100%" ZoomMode="PageWidth" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
        <LocalReport ReportPath="InformacoesGerenciais\RelReservasCanceladas.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
    <p>
        <br />
