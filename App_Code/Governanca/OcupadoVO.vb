...
Public Class OcupadoVO
    ...
    Public Property Emprestimos() As String
        ...
        End Set
    End Property
    Public Property HosDataFimReal() As String
        Get
            Return Me._HosDataFimreal
        End Get
        Set(ByVal value As String)
            If (_HosDataFimReal <> value) Then
                Me._HosDataFimReal = value
            End If
        End Set
    End Property
    Public Property CSeOrigem() As String
        Get
            Return Me._CSeOrigem
        End Get
        Set(ByVal value As String)
            If (_CSeOrigem <> value) Then
                Me._CSeOrigem = value
            End If
        End Set
    End Property
    Public Property CSeManual() As String
        Get
            Return Me._CSeManual
        End Get
        Set(ByVal value As String)
            If (_CSeManual <> value) Then
                Me._CSeManual = value
            End If
        End Set
    End Property
    Public Property CSeDescricao() As String
        Get
            Return Me._CSeDescricao
        End Get
        Set(ByVal value As String)
            If (_CSeDescricao <> value) Then
                Me._CSeDescricao = value
            End If
        End Set
    End Property
