...
<TABLE cellSpacing=0 cellPadding=0 width=640 border=1 bordercolor="#C0C0C0">
  ...
  <TR>
    <TD align=left width="640" height="28" colspan="4">
      <p align="center">
      <FONT face=arial size=2><b><i>As diárias de hospedagem na Pousada SESC Pirenópolis incluem apenas café da manhã.</center></i></b>
      </FONT>
    </TD>
  </TR>
  <TR>
    <TD align=left width="640" height="1" colspan="4">
      <center><b><font face="arial" size="3">ATENÇÃO</font></b></center><b><font face="arial" size="2">(*) Valores e serviços sujeitos a alteração.</font></b>
  	  <br><font face="arial" size="1">O Valor deste Documento corresponde a <%response.write Percentual%> % do valor da reserva de <%response.write QdtePess%> hóspede(s).
      ...
      <BR>Na portaria do SESC Pirenópolis é necessária a apresentação de documento de identidade e Carteira do SESC atualizada.
